...
namespace mst
{
  ...
  public:
    ...
    inline void ClearOscillationProb()
    {
      if (fOscillogram)
        delete fOscillogram;
      fOscillogram = nullptr;
    }
  ...
  protected:
    ...
    {
      if (procedure_name == "sampling")
        return MCRealizationProcedure::kSampling;
      else if (procedure_name == "bin_sampling")
        return MCRealizationProcedure::kBinSampling;
      else if (procedure_name == "asimov")
        return MCRealizationProcedure::kAsimov;
      else
        return MCRealizationProcedure::kUndefined;
    }
